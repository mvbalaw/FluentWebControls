...
namespace FluentWebControls.Tests
{
	public class ValidatableWebControlBaseTest
	{
		...
		{
			public ValidatableTest(IPropertyMetaData propertyMetaData)
		...
		public class When_asked_to_build_JQueryValidation_for_input
		{
			...
			public void Should_append_Date_validation_string_for_date_input()
			{
				...
				_cssClass = "testClass";
				ValidatableTest validatableTest = new ValidatableTest(_propertyMetaData);
			...
			[Test]
			public void Should_append_Required_validation_string_for_input_that_maps_to_a_property_that_is_notnull()
			{
			...
			[Test]
			public void Should_not_append_Required_validation_string_for_input_that_maps_to_a_property_that_canbenull()
			{
